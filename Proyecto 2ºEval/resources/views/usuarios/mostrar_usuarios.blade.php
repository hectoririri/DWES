                    ...
                    @foreach ($usuarios as $usuario)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{!! route("usuarios.show", ['usuario' => $usuario]) !!}" class="btn btn-outline-primary">
                            ...
                            {{-- cambiar a route --}}
                            <td class="text-center">
                                <a href="{!! route("usuarios.edit", ['usuario' => $usuario]) !!}" class="btn btn-outline-secondary">
                            ...
                            {{-- cambiar a route --}}
                            <td class="text-center">
                                <a href="{!! route("confirmar.eliminar.usuario", ['usuario' => $usuario]) !!}" class="btn btn-outline-danger">
