    ...
    <tbody>
        @foreach ($clientes as $cliente)
            <tr class="text-center">
                ...
                <td>{{ $cliente->fecha_actualizado }}</td>
                <td>
                    <a href="{!! route("clientes.show", ['cliente' => $cliente]) !!}" class="btn btn-outline-primary">
                ...
                <td>
                    <a href="{!! route("clientes.edit", ['cliente' => $cliente]) !!}" class="btn btn-outline-secondary">
                ...
                <td>
                    <a href="{!! route('confirmar.eliminar.cliente', ['cliente' => $cliente]) !!}" class="btn btn-outline-danger">
