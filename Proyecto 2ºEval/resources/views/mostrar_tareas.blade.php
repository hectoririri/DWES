    ...
    <tbody>
        @foreach ($tareas as $tarea)
            <tr class="text-center">
                ...
                <td>
                    <a href="{!! route("tareas.show", ['tarea' => $tarea->id]) !!}" class="btn btn-outline-primary">
                    ...
                    <td>
                        <a href="{!! route("tareas.edit", ['tarea' => $tarea->id]) !!}" class="btn btn-outline-secondary">
                    ...
                    <td>
                        <a href="{!! route('confirmar.eliminar.tarea', ['tarea' => $tarea->id]) !!}" class="btn btn-outline-danger">
                ...
                <td>
                    @if ($tarea->estado=='P' || $tarea->estado=='B')
                    <a href="{!! route("completar.tarea", ['tarea' => $tarea->id]) !!}" class="btn btn-outline-success">
