                    ...
                    @foreach ($usuarios as $usuario)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{!! route("usuarios.show", ['usuario' => $usuario->id]) !!}" class="btn btn-outline-primary">
                            ...
                            {{-- cambiar a route --}}
                            <td class="text-center">
                                <a href="{!! route("usuarios.edit", ['usuario' => $usuario->id]) !!}" class="btn btn-outline-secondary">
                            ...
                            {{-- cambiar a route --}}
                            <td class="text-center">
                                <a href="{!! route("confirmar.eliminar.usuario", ['usuario' => $usuario->id]) !!}" class="btn btn-outline-danger">
