...
-- Volcando estructura de base de datos para albanileria_prueba
CREATE DATABASE IF NOT EXISTS `albanileria_prueba` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
USE `albanileria_prueba`;
...
INSERT INTO `clientes` (`id`, `cif`, `nombre`, `telefono`, `correo`, `pais`, `cuenta_corriente`, `moneda`, `importe_mensual`, `fecha_alta`, `fecha_actualizado`) VALUES
	(1, '54794584M', 'Empresa S.A.', '+34 123-45-67-89', 'contacto@empresa.com', 008, 'ES7620770024003102575766', 'EUR', 1000.0000, '2023-01-01', NULL),
	(2, 'B23456789', 'Compañía SL', '900234567', 'info@compania.com', 004, 'ES9121000418450200051332', 'EUR', 2000.0000, '2023-02-01', NULL),
	(3, 'C34567890', 'Negocio SL', '900345678', 'contacto@negocio.com', 010, 'ES7620770024003102575767', 'EUR', 1500.0000, '2023-03-01', NULL),
	(4, 'D45678901', 'Industria SA', '900456789', 'info@industria.com', 016, 'ES9121000418450200051333', 'EUR', 2500.0000, '2023-04-01', NULL),
	(5, 'E56789012', 'Servicios SL', '900567890', 'contacto@servicios.com', 012, 'ES7620770024003102575768', 'EUR', 3000.0000, '2023-05-01', NULL),
	(6, 'F67890123', 'Comercio SA', '900678901', 'info@comercio.com', 020, 'ES9121000418450200051334', 'EUR', 3500.0000, '2023-06-01', NULL),
	(7, 'G78901234', 'Consultoria SL', '900789012', 'contacto@consultoria.com', 032, 'ES7620770024003102575769', 'EUR', 4000.0000, '2023-07-01', NULL),
	(8, 'H89012345', 'Tecnologia SA', '900890123', 'info@tecnologia.com', 036, 'ES9121000418450200051335', 'EUR', 4500.0000, '2023-08-01', NULL);

-- Volcando estructura para tabla albanileria_prueba.cuota
CREATE TABLE IF NOT EXISTS `cuota` (
  ...
  CONSTRAINT `cuota_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- Volcando datos para la tabla albanileria_prueba.migrations: ~3 rows (aproximadamente)
...
-- Volcando estructura para tabla albanileria_prueba.paises
...
-- Volcando datos para la tabla albanileria_prueba.paises: ~241 rows (aproximadamente)
DELETE FROM `paises`;
...
-- Volcando estructura para tabla albanileria_prueba.password_reset_tokens
...
-- Volcando datos para la tabla albanileria_prueba.password_reset_tokens: ~0 rows (aproximadamente)
DELETE FROM `password_reset_tokens`;

-- Volcando estructura para tabla albanileria_prueba.provincias
...
-- Volcando datos para la tabla albanileria_prueba.provincias: ~52 rows (aproximadamente)
...
-- Volcando estructura para tabla albanileria_prueba.remesa
...
-- Volcando datos para la tabla albanileria_prueba.remesa: ~0 rows (aproximadamente)
DELETE FROM `remesa`;

-- Volcando estructura para tabla albanileria_prueba.sessions
...
CREATE TABLE IF NOT EXISTS `tareas` (
  ...
  KEY `cliente_id` (`cliente_id`),
  CONSTRAINT `tareas_ibfk_1` FOREIGN KEY (`operario_id`) REFERENCES `users` (`id`),
  CONSTRAINT `tareas_ibfk_2` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`)
...
INSERT INTO `tareas` (`id`, `descripcion`, `direccion`, `poblacion`, `cod_postal`, `provincia`, `estado`, `fecha_creacion`, `fecha_realizacion`, `fecha_actualizacion`, `operario_id`, `cliente_id`, `anotaciones_anteriores`, `anotaciones_posteriores`, `fichero`, `foto`) VALUES
	(42, 'Instalación de tuberías', 'Av. Andalucía 45', 'Sevilla', '41005', 'Sevilla', 'B', '2025-01-18 00:00:00', NULL, NULL, 2, 1, NULL, NULL, NULL, NULL),
	(43, 'Pintado de fachada', 'Calle Gran Vía 30', 'Barcelona', '08010', 'Barcelona', 'R', '2025-01-10 00:00:00', '2025-01-15 00:00:00', '2025-01-16 00:00:00', 3, 2, 'Fachada en mal estado', 'Trabajo finalizado con éxito', 'presupuesto.pdf', 'fachada_final.jpg'),
	(44, 'Cambio de baldosas', 'Calle Serrano 8', 'Madrid', '28006', 'Madrid', 'P', '2025-01-22 00:00:00', NULL, NULL, 4, 5, NULL, NULL, NULL, NULL),
	(45, 'Revisión eléctrica', 'Calle Alcazaba 7', 'Málaga', '29015', 'Málaga', 'B', '2025-01-19 00:00:00', NULL, NULL, 1, 4, 'Algunas luces parpadean', 'Esperando aprobación del cliente', NULL, NULL),
	(46, 'Impermeabilización de terraza', 'Av. Libertad 32', 'Valencia', '46002', 'Valencia', 'C', '2025-01-12 00:00:00', NULL, '2025-01-14 00:00:00', 2, 6, 'Filtraciones en techo inferior', 'Cliente canceló por presupuesto alto', NULL, NULL),
	(47, 'Colocación de pladur', 'Calle Río Ebro 5', 'Zaragoza', '50002', 'Zaragoza', 'P', '2025-01-23 00:00:00', NULL, NULL, 3, 2, NULL, NULL, NULL, NULL),
	(48, 'Pavimentación de garaje', 'Calle Real 20', 'Granada', '18001', 'Granada', 'R', '2025-01-05 00:00:00', '2025-01-08 00:00:00', '2025-01-09 00:00:00', 4, 3, 'Hormigón anterior muy deteriorado', 'Obra completada', 'factura.pdf', 'garaje_nuevo.jpg'),
	(49, 'Sustitución de ventanas', 'Av. Castilla 14', 'Valladolid', '47008', 'Valladolid', 'P', '2025-01-24 00:00:00', NULL, NULL, 1, 7, NULL, NULL, NULL, NULL),
	(50, 'Reforma integral de baño', 'Calle Sol 3', 'Alicante', '03001', 'Alicante', 'B', '2025-01-17 00:00:00', NULL, NULL, 2, 8, 'Baño con instalaciones antiguas', 'Aprobado, en espera de materiales', 'presupuesto_baño.pdf', NULL),
	(51, 'tareita', 'direccion', 'poblacion', '21006', 'Girona', 'P', '2025-02-06 00:00:00', '2025-02-06 00:00:00', '2025-02-06 00:00:00', 7, 0, 'anterior', 'posterior', NULL, NULL),
	(52, 'Tarea como administrador', 'mi casa', 'huelvaloen', '21006', 'Castellón', 'P', '2025-02-06 00:00:00', '2025-02-21 00:00:00', '2025-02-06 00:00:00', 3, 0, 'anterior', 'posterior', NULL, NULL),
	(53, 'tarea', NULL, NULL, '21006', 'Girona', 'P', '2025-02-06 00:00:00', '2025-03-02 00:00:00', '2025-02-06 00:00:00', 4, 5, NULL, NULL, NULL, NULL),
	(54, 'tarea', NULL, NULL, '21006', 'Girona', 'P', '2025-02-06 00:00:00', '2025-03-02 00:00:00', '2025-02-06 00:00:00', 4, 0, NULL, NULL, NULL, NULL),
	(55, 'tarea', NULL, NULL, '21006', 'Girona', 'P', '2025-02-06 00:00:00', '2025-03-02 00:00:00', '2025-02-06 00:00:00', 4, 6, NULL, NULL, NULL, NULL),
	(56, 'nueva tarea con fechas', 'Avenida Siempre Viva 456', 'Barcelona', '52002', 'Granada', 'R', '2025-02-06 09:01:00', '2025-02-28 10:01:00', '2025-02-06 09:02:30', 14, 7, 'anterior', 'posterior', NULL, NULL),
	(57, 'Tarea sin operario', 'Avenida Siempre Viva 456', 'Huelva', '52002', 'Guadalajara', 'R', '2025-02-11 08:22:00', '2025-02-28 09:22:00', '2025-02-11 08:22:41', NULL, 1, 'anotacion anterior', NULL, NULL, NULL);
