...
-- Volcando datos para la tabla albanileria_prueba.cache: ~2 rows (aproximadamente)
DELETE FROM `cache`;
INSERT INTO `cache` (`key`, `value`, `expiration`) VALUES
	('juan.perez@example.com|127.0.0.1', 'i:1;', 1738711759),
	('juan.perez@example.com|127.0.0.1:timer', 'i:1738711759;', 1738711759);

-- Volcando datos para la tabla albanileria_prueba.cache_locks: ~0 rows (aproximadamente)
DELETE FROM `cache_locks`;

-- Volcando datos para la tabla albanileria_prueba.clientes: ~10 rows (aproximadamente)
...
INSERT INTO `clientes` (`id`, `cif`, `nombre`, `telefono`, `correo`, `pais`, `cuenta_corriente`, `moneda`, `importe_mensual`, `fecha_alta`, `fecha_actualizado`, `deleted_at`) VALUES
	(1, '54794584M', 'Empresa S.A.', '+34 123-45-67-89', 'contacto@empresa.com', 000, 'ES7620770024003102575766', 'EUR', 1000.0000, '2022-12-31 23:00:00', '2025-02-11 23:45:42', '2025-02-11 23:45:42'),
	(2, 'B23456789', 'Compañía SL', '900234567', 'info@compania.com', 000, 'ES9121000418450200051332', 'EUR', 2000.0000, '2023-01-31 23:00:00', NULL, NULL),
	(3, 'C34567890', 'Negocio SL', '900345678', 'contacto@negocio.com', 000, 'ES7620770024003102575767', 'EUR', 1500.0000, '2023-02-28 23:00:00', NULL, NULL),
	(4, 'D45678901', 'Industria SA', '900456789', 'info@industria.com', 000, 'ES9121000418450200051333', 'EUR', 2500.0000, '2023-03-31 22:00:00', NULL, NULL),
	(5, 'E56789012', 'Servicios SL', '900567890', 'contacto@servicios.com', 000, 'ES7620770024003102575768', 'EUR', 3000.0000, '2023-04-30 22:00:00', '2025-02-11 23:43:58', '2025-02-11 23:43:58'),
	(6, 'F67890123', 'Comercio SA', '900678901', 'info@comercio.com', 000, 'ES9121000418450200051334', 'EUR', 3500.0000, '2023-05-31 22:00:00', NULL, NULL),
	(7, 'G78901234', 'Consultoria SL', '900789012', 'contacto@consultoria.com', 000, 'ES7620770024003102575769', 'EUR', 4000.0000, '2023-06-30 22:00:00', NULL, NULL),
	(8, 'H89012345', 'Tecnologia SA', '900890123', 'info@tecnologia.com', 000, 'ES9121000418450200051335', 'EUR', 4500.0000, '2023-07-31 22:00:00', '2025-02-11 23:47:04', '2025-02-11 23:47:04'),
	(9, '54794584M', 'Tecnirotulos', '+34-123-45-67-89', 'hecnguar@gmail.com', 052, 'ES9121000418140200051332', 'BBD', 12.3000, '2025-02-12 01:53:54', '2025-02-12 02:55:28', '2025-02-12 02:55:28'),
	(10, '54794584M', 'asda', '+34-123-45-67-89', 'hecnugar@gmail.com', 051, 'ES9121000418450200051332', 'BAM', 399.9900, '2025-02-12 02:56:02', '2025-02-12 02:58:15', '2025-02-12 02:58:15');
...
-- Volcando datos para la tabla albanileria_prueba.tareas: ~12 rows (aproximadamente)
DELETE FROM `tareas`;
INSERT INTO `tareas` (`id`, `descripcion`, `direccion`, `poblacion`, `cod_postal`, `provincia`, `estado`, `fecha_creacion`, `fecha_realizacion`, `fecha_actualizacion`, `operario_id`, `cliente_id`, `anotaciones_anteriores`, `anotaciones_posteriores`, `fichero`, `foto`) VALUES
	(41, 'Reparación de fuga en baño', 'Calle Mayor 12', 'Madrid', '28001', 'Madrid', 'P', '2025-01-20 00:00:00', NULL, '2025-01-21 00:00:00', 1, 3, 'Detectada fuga bajo lavabo', 'Pendiente de aprobación', NULL, NULL),
	...
	(45, 'Revisión eléctrica', 'Calle Alcazaba 7', 'Málaga', '29015', 'Málaga', 'R', '2025-01-19 00:00:00', '2025-01-29 03:21:00', '2025-02-07 01:36:27', 13, 4, 'Algunas luces parpadean', 'Cliente aprobado', NULL, NULL),
	...
	(48, 'Pavimentación de garaje', 'Calle Real 20', 'Granada', '18001', 'Granada', 'R', '2025-01-05 00:00:00', '2025-01-08 00:00:00', '2025-01-09 00:00:00', 13, 3, 'Hormigón anterior muy deteriorado', 'Obra completada', 'factura.pdf', 'garaje_nuevo.jpg'),
	...
	(51, 'tareaita prueba 123', 'Calle Puerto', 'Aljaraque', '21904', 'Coruña (A)', 'P', '2025-02-06 00:00:00', '2025-02-08 00:00:00', '2025-02-06 00:00:00', 13, 5, 'anterior', 'posterior', NULL, NULL),
	(52, 'tarea sin iniciar sesión', 'direccionamiento', 'alguna', '21092', 'Cuenca', 'R', '2025-02-06 00:00:00', '2025-02-28 00:00:00', '2025-02-06 00:00:00', NULL, 1, 'Anotaciones anteriores', 'Anotaciones posteriores', NULL, NULL);
...
INSERT INTO `users` (`id`, `dni`, `name`, `email`, `telefono`, `direccion`, `rol`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, '12345678Z', 'Juan Pérez', 'juan.perez@gmail.com', '+34-123-45-67-89', 'Calle Mayor 12, Madrid', 'O', NULL, 'Contraseña56@', NULL, '2025-01-01 09:00:00', '2025-02-04 22:21:20', NULL),
	...
	(3, '11223344C', 'Carlos Sánchez', 'carlos.sanchez@example.com', '620345678', 'Calle Gran Vía 30, Barcelona', 'O', NULL, 'hashed_password_3', NULL, '2025-01-03 08:45:00', '2025-02-11 23:44:55', '2025-02-11 23:44:55'),
	...
	(13, '54794584M', 'Hector', 'hecnugar@gmail.com', '+34-123-45-67-89', 'Calle Falsa', 'A', NULL, '$2y$12$qaONa/5YDD41hjl88sB0YOJO2DsyWFP9QnWvjMRx90ec1R5cymwOu', NULL, '2025-02-04 21:49:18', '2025-02-04 21:49:18', NULL);
