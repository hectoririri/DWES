...
-- Volcando estructura para tabla albanileria_prueba.remesas
...
-- Volcando datos para la tabla albanileria_prueba.remesas: ~0 rows (aproximadamente)
DELETE FROM `remesas`;
...
CREATE TABLE IF NOT EXISTS `tareas` (
  ...
  `provincia` char(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `cliente_id` (`cliente_id`),
  KEY `tareas_provincia_foreign` (`provincia`),
  CONSTRAINT `tareas_ibfk_1` FOREIGN KEY (`operario_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `tareas_ibfk_2` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `tareas_provincia_foreign` FOREIGN KEY (`provincia`) REFERENCES `provincias` (`cod`) ON DELETE SET NULL ON UPDATE CASCADE
)

-- Volcando datos para la tabla albanileria_prueba.tareas: ~16 rows (aproximadamente)
-- Volcando datos para la tabla albanileria_prueba.tareas
DELETE FROM `tareas`;
INSERT INTO `tareas` (`id`, `telefono_contacto`, `persona_contacto`, `descripcion`, `direccion`, `poblacion`, `cod_postal`, `provincia`, `estado`, `fecha_creacion`, `fecha_realizacion`, `fecha_actualizacion`, `operario_id`, `cliente_id`, `anotaciones_anteriores`, `anotaciones_posteriores`, `fichero`, `foto`) VALUES
    ...
    (51, NULL, NULL, 'tareita', 'direccion', 'poblacion', '21006', '20', 'P', '2025-02-06 00:00:00', '2025-02-06 00:00:00', '2025-02-06 00:00:00', 14, NULL, 'anterior', 'posterior', NULL, NULL),
    (52, NULL, NULL, 'Tarea como administrador', 'mi casa', 'huelvaloen', '21006', '04', 'P', '2025-02-06 00:00:00', '2025-02-21 00:00:00', '2025-02-06 00:00:00', 3, NULL, 'anterior', 'posterior', NULL, NULL),
    ...
    (54, NULL, NULL, 'tarea', NULL, NULL, '21006', '51', 'P', '2025-02-06 00:00:00', '2025-03-02 00:00:00', '2025-02-06 00:00:00', 4, NULL, NULL, NULL, NULL, NULL),
